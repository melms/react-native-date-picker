...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
    ...
    if (oldViewProps.mode != newViewProps.mode) {
        ...
        if(newViewProps.mode == RNDatePickerMode::Date) [_picker setDatePickerMode:(UIDatePickerMode)4269];
        if(newViewProps.mode == RNDatePickerMode::Datetime) [_picker setDatePickerMode:(UIDatePickerMode)4269];
